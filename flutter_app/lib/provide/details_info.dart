...
//  设置一个变量默认为空
  ...
  getGoodsInfo(String id) async {
    ...
    await request('Shop-Shop-getGoodsInfo', formData: formData).then((val) {
      if (val['status'] == 0) {
        goodsInfo = val['data'];
        ...
        goodsInfo['checkvalue'] = goodsInfo["goodsInfo"]['attr'][0]['goods_attr_value'];
        goodsInfo['specindex'] = 0 ;
        print(goodsInfo['specindex']);
        notifyListeners();
      }
    });
  }
