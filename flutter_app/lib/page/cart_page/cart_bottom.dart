...
class CartBottom extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
        margin: EdgeInsets.fromLTRB(ScreenUtil().setWidth(25),0,ScreenUtil().setWidth(25),0),
        padding: EdgeInsets.fromLTRB(0,ScreenUtil().setWidth(15),0,ScreenUtil().setWidth(15)),
