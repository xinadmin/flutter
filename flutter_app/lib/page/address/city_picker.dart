...
class CityPicker {
  static void showCityPicker(
    ...
    rootBundle.loadString('data/address.json').then((v) {
...
class _CityPickerState extends State<_CityPickerWidget> {
  ...
  void initState() {
    ...
    setState(() {
      ...
      city = widget.data[provinceIndex]['value'];
      area = widget.data[provinceIndex]['value'][cityIndex]['value'];
    });
  }
...
//                            ['code'],
                        "name": province[provinceIndex]['value'][cityIndex]
                            ['name']
                      };
                      Map<String, dynamic> areaMap = {
//                        "code": province[provinceIndex]['sub'][cityIndex]['sub']
//                            [areaIndex]['code'],
                        "name": province[provinceIndex]['value'][cityIndex]['value']
                            [areaIndex]['name']
                      };
                ...
                new _MyCityPicker(
                  ...
                  changed: (index) {
                    setState(() {
                      ...
                      city = widget.data[provinceIndex]['value'];
                      area =
                          widget.data[provinceIndex]['value'][cityIndex]['value'];
                    });
                  },
                ),
                new _MyCityPicker(
